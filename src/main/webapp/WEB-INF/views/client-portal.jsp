    ...
    <div class="portal-card">
        ...
        <form action="client-portal" method="post" class="mb-4">
            ...
            <div class="mb-3">
                ...
                <input type="tel" name="telephone" class="form-control" placeholder="03xxxxxxxx" required>
            </div>
            ...
            <form action="client-portal" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="tel" name="telephone" class="form-control" value="<%= request.getAttribute("prefilledPhone") != null ? request.getAttribute("prefilledPhone") : "" %>" placeholder="03xxxxxxxx" required>
                    </div>
                </div>
